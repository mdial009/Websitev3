...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(32836000176688656418)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32836000440919656418)
,p_plug_template_id=>wwv_flow_api.id(32836000176688656418)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32836000780371656418)
,p_plug_template_id=>wwv_flow_api.id(32836000176688656418)
,p_name=>'Tabs'
