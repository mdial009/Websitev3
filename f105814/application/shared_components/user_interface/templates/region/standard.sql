...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(32835993383207656415)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835993694055656415)
,p_plug_template_id=>wwv_flow_api.id(32835993383207656415)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835993998451656415)
,p_plug_template_id=>wwv_flow_api.id(32835993383207656415)
,p_name=>'Sub Regions'
