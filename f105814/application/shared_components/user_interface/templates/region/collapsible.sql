...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(32835973186119656406)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835973431894656407)
,p_plug_template_id=>wwv_flow_api.id(32835973186119656406)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835973745760656407)
,p_plug_template_id=>wwv_flow_api.id(32835973186119656406)
,p_name=>'Sub Regions'
