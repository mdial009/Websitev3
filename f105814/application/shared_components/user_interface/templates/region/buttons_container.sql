...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(32835962767827656402)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835963005036656403)
,p_plug_template_id=>wwv_flow_api.id(32835962767827656402)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835963353052656403)
,p_plug_template_id=>wwv_flow_api.id(32835962767827656402)
,p_name=>'Sub Regions'
