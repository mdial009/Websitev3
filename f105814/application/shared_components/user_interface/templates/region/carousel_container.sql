...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(32835965990390656404)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835966230409656404)
,p_plug_template_id=>wwv_flow_api.id(32835965990390656404)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(32835966557448656404)
,p_plug_template_id=>wwv_flow_api.id(32835965990390656404)
,p_name=>'Slides'
